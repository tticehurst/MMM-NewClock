  ...
  getDom: function () {
    ...
    if (this.config.showSunTimes) {
      ...
      sunWrapper.innerHTML =
        `<span class="${
          isVisible ? "bright" : ""
        }"><i class="fas fa-sun" aria-hidden="true"></i> ${untilNextEventString}</span>` +
    ...
    if (this.config.showMoonTimes) {
      ...
      moonWrapper.innerHTML =
        `<span class="${
          isVisible ? "bright" : ""
        }"><i class="fas fa-moon" aria-hidden="true"></i> ${illuminatedFractionString}</span>` +
